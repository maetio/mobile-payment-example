...
/*
    ...
    Customizing RTK Query with 
        firebase functions: https://stackoverflow.com/questions/71587312/is-it-possible-to-use-firebase-query-with-redux-toolkit-or-rtk-query-in-react)
...
export const firebaseAuthApi = emptyFirebaseApi.injectEndpoints({
    endpoints: (build) => ({
        /* 
